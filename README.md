...
앱 UI 텍스트도 i18n 마이그레이션 완료(Phase 2-C1). 헤더·홈 카드·검색·디테일·TTS·라이브러리·저널 큐레이션(호/주제/트렌드) 모두 영어 완성. 설정 드로어·계정/결제/온보딩·약관은 다음 사이클(C2/C3). 영어 사용자가 검색→요약→청취→저널 탐색까지 끝까지 영어로 완주 가능.
