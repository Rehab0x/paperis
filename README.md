...
앱 UI 텍스트도 i18n 마이그레이션 완료(Phase 2-C1·2-C2). 헤더/홈/검색·디테일/TTS·라이브러리/저널 큐레이션(호/주제/트렌드)/설정 드로어/계정·결제·온보딩까지 모두 영어. 남은 한국어는 `legal/*` 약관 페이지(C3, 법률 검토 필요)뿐. 영어 사용자가 검색→요약→청취→저널 탐색→결제·계정 관리까지 끝까지 영어로 완주 가능.
