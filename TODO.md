...
lib/
  ...
  openalex.ts                    enrichPapers (Works) + searchJournalsByField/Name (Sources, v3)
...
- M2 ✅ — `data/journals.json` 카탈로그 + `lib/journals.ts` + OpenAlex `searchJournalsByField/Name`
- M3 다음 — 저널 큐레이션 UI/API 4종 (호·주제·트렌드)
